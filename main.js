...
async function loadText(url, event){
  ...
  try{
    ...
    console.log('something went wrong while trying to fetch and load the text: ', error);
  }
}
...
document.querySelector('#location-container').addEventListener('fetching', loadText.bind(this, 'http://localhost:3001/geo'));
